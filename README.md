<div align="center">
 <h1> Hyprland install on Arch Linux </h1>
</div>
...
1. Clone the repo
```
git clone https://github.com/owlsly94/hyprland.git
cd hyprland
```
2. Make sure the `install.sh` script is executable and execut it
```
chmod +x install.sh
sh install.sh
```
...
gamemoded -t
```
4. To set a wallpaper, either use:<br>
